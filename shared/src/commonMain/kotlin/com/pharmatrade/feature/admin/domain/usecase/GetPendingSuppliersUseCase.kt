...
class GetPendingSuppliersUseCase(private val repository: AdminRepository) {
    suspend operator fun invoke(): Result<List<PendingUser>> = repository.getPendingSuppliers()
}
